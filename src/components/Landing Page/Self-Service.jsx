...
function SelfService() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
      ...
      <Typography sx={{ textAlign: 'center', px: 2 }}>Access the most commonly utilized support tools.</Typography>
          ...
          <Grid item xs={12} sm={4} md={4} lg={3}>
            <Item sx={{ py: 4, boxShadow: 0 }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Typography sx={{ color: '#999' }}>Changes Account Login Password</Typography>
              </Box>
            </Item>
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={3}>
            <Item sx={{ py: 4, boxShadow: 0 }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Typography sx={{ color: '#999' }}>Deposit not showing up in wallet?</Typography>
              </Box>
            </Item>
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={3}>
            <Item sx={{ py: 4, boxShadow: 0 }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Typography sx={{ color: '#999' }}>Think your account has been hacked?</Typography>
              </Box>
            </Item>
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={3}>
            <Item sx={{ py: 4, boxShadow: 0 }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Typography sx={{ color: '#999' }}>Manage you mobile login.</Typography>
              </Box>
            </Item>
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={3}>
